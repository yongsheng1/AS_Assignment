...
<body>
    ...
    <header class="user__header">
            ...
            <h1 class="user__title">Home Page</h1>
        </header>
    <form id="form1" runat="server" class="form">
                ...
                <asp:Label ID="lblMessage" runat="server" EnableViewState="false" CssClass="form__input"/>
                <br />
                <br />

                <asp:Button ID="btnLogout" runat="server" Text="Logout" OnClick="LogoutMe" Visible="false" CssClass="btn"/>
                <p />
                <br />
                <br />
               </div>
           ...
           <div class="form__group">
             <asp:Button ID="btn_pass" runat="server" Text="Change Password" OnClick="Changepass" CssClass="btn"  />
        </div>
    </form>
